...
class TestLoadData:
    ...
    def test_load_parquet(self, temp_parquet_file):
        ...
        config = {
            "data_path": str(temp_parquet_file),
            "data_type": "parquet"
        }
...
class TestCreateModellingData:
    ...
    def test_create_modelling_data_basic(self, sample_classification_data, classifier_config):
        ...
        X_train, y_train, X_test, y_test, feature_names, cat_indices, exp_train, exp_test = create_modelling_data(
            sample_classification_data,
            classifier_config
        )
