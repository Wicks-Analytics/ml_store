...
class TestSHAPAnalysis:
    ...
    def test_calculate_shap_values(self, sample_classification_data):
        ...
        model = train_model(X_train, y_train, config=config, categorical_features=cat_indices, verbose=0)
...
class TestPoolCreation:
    ...
    def test_create_pool_from_config(self, classifier_config):
        ...
        X, _, feature_names, cat_indices, _ = prepare_features(df, classifier_config, is_training=False)
